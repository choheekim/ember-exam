...
module.exports = TestCommand.extend({
  ...
  availableOptions: [
    ...
    { name: 'load-balance',     type: Number,                   aliases: ['lb'],  description: 'Loads your test balanced' },
    { name: 'random',           type: String,  default: false,                    description: 'Randomizes your modules and tests while running your test suite.' },
    { name: 'replay-execution', type: String,  default: false,  aliases: ['re'],  description: 'A JSON file path which maps from browser number to a list of modules'},
    { name: 'replay-browser',   type: [Array, Number],          aliases: ['rb'],  description: 'The number of the browser(s) to run from a specified file path'}
