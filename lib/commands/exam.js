...
module.exports = TestCommand.extend({
  ...
  _generateCustomConfigs: function(commandOptions) {
    ...
    if (shouldParallelize && typeof ids == 'undefined') {
      ids = [];
      ...
      let browserCount = commandOptions.loadBalance;
  ...
  _getCustomBaseUrl: function(config, commandOptions) {
    ...
    const appendParamToBaseUrl = function(baseUrl) {
      ...
      if (command.validator.shouldLoadBalance) {
  ...
  /**
   * Generates multiple test pages with browser ids.
   *
