...
module.exports = TestCommand.extend({
  ...
  _addBrowserSocketEventsToConfig: function(config) {
    ...
    events['get-next-module'] = function () {
      const proto = Object.getPrototypeOf(this)
      const moduleName = proto.moduleQueue.shift();
    ...
    events['after-tests-complete'] = function () {
      ...
      const numOfBrowsersOfModuleMap = Object.keys(proto.moduleMap).length;

      if(proto.finishedBrowsers === undefined) {
        proto.finishedBrowsers = 1;
      }

      const testPages = config.testPage;
      const browserCount = Object.keys(testPages).length;

      let moduleMapJsonObj = {};
      moduleMapJsonObj['numberOfBrowsers'] = numOfBrowsersOfModuleMap;
      moduleMapJsonObj['executionMapping'] = proto.moduleMap;

      if (proto.finishedBrowsers == browserCount) {
        const testExecutionJson = JSON.stringify(moduleMapJsonObj);
